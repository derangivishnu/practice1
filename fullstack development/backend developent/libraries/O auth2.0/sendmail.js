...
var mytoken = 'fzldmdwelctrjnvc';
var mailSender = function (name, email, subject, text) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        mailoptions = {
            ...
            text: "Hi ".concat(name).concat(text)
        };
